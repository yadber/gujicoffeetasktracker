...
export default function TextInput({placeholder, type, min,setting, name, onChange, value, height}) {
  return (
    ...
    <div className="relative mb-4">
        ...
        onChange={onChange}
        value={value}
        className={`block px-2.5 pb-2.5 pt-4 w-full text-sm  ${height?`h-${height}` : `h-[30px]`}
