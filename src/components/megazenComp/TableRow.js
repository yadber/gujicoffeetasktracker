  ...
  return (
    ...
    >
      <div className="flex gap-1">
        ...
        <div className={`${onMouseOver2(location) >=0 && calculateTime(onMouseOver2(location)) <14?"border h-5 w-5 text-center justify-center align-middle mt-[-0.9rem] border-red-400  rounded-full font-bold text-red-900":null}`} id={location+"bottom"}>
        </div>
